...
- **專案規範合規**：`SplitM2eICManager` 為 M3G 的活躍開發檔（本 session MINCORE 的 SoftInboundCommitted/Progress/γ 皆 gated 加於此），故 gated 加飢餓項一致；關掉即現行 M3G。不動 M1G/HADGS/PVGS/HGS 檔。
