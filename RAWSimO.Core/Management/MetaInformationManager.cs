...
namespace RAWSimO.Core.Management
{
    ...
    internal class ShortestPathManager
    {
        ...
        /// <param name="to"></param>
        /// <param name="wrongTierPenaltyDistance"></param>
        /// <param name="emulatePodCarrying"></param>
        /// <returns></returns>
        public double GetShortestPath1(Waypoint from, Waypoint to, double wrongTierPenaltyDistance, bool emulatePodCarrying)
        {
            // Return the value
